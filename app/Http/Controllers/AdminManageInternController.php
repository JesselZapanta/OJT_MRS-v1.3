...
class AdminManageInternController extends Controller
{
    //
    public function manageinternview(){
        $interns = User::where('userole', 'intern')->where('status', 'approved')->get();
        return view('admin.manageIntern')->with('interns', $interns);
    }
    ...
    public function viewinternprofile(User $intern){
        ...
        return view('admin.viewinternprofile', [
            'intern' => $intern,
            'requirements' => $requirements
        ]);
    }

    public function updateinternprofile(User $intern, Request $request){
        ...
        return redirect()->route('admin.viewinternprofile', ['intern' => $intern])->with('success', 'Updates Successful.');
    }
    ...
    public function deleteintern(User $intern){
        ...
        return redirect()->route('admin.manageintern')->with('success', 'Deleted Successfully');
    }
