...
class InternController extends Controller
{
    ...
    public function index(){
        ...
        $submittedReq = SubmittedRequirement::where('userId', $userId)->count();
        $approvedReq = SubmittedRequirement::where('userId', $userId)->where('status', 'approved')->count();
        return view('intern.interndashboard', [
            'user' => $user, 
    ...
    public function internprofile(){
        $intern = Auth::user();
        return view('intern.internprofile')->with('intern', $intern);;
    }

    public function update(User $intern, Request $request){
        ...
        // $intern->update($data);
        return redirect()->route('internprofile', ['intern' => $intern])->with('success', 'Updated Successfully.');
    }
}
