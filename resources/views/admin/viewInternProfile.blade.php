  ...
  <body>
    ...
    <section id="sidebar">
      ...
      <ul class="side-menu">
        ...
        <li>
          <a href="{{ route('admin.manageinternview') }}" class="active"
    ...
    <section id="content">
      ...
      <main>
        ...
        <ul class="breadcrumbs">
          <li><a href="#">Manage Intern</a></li>
          <li class="divider">/</li>
          <li><a href="#" class="active">Profile</a></li>
        </ul>
        <!-- Form -->
          <form method="post" action="{{ route('admin.updateInternprofile', ['intern' => $intern ]) }}" enctype="multipart/form-data">
          @csrf
          @method('put')
            ...
            <div class="form_content">
              <div class="form_group">
                ...
                <div class="form_btn_container view">
                  <a href="{{ route('admin.manageinternview') }}" class="btn back_btn">Back</a>
          ...
          @if($requirements->isNotEmpty())
            <div class="form_container profile">
              <h1 class="title">Submitted Approved Requirements</h1>
              <div class="approve_forms_container">
                @foreach ($requirements as $requirement)
                    <div class="form_container profile">
                      <h4 class="req_name">{{ $requirement->setRequirement->name }}</h4>
                      <div class="form_content">
                        <div class="form_group">
                          <div class="form_input">
                            <iframe
            ...
            @else
            <div class="form_container profile">
              <h1 class="title">No Approved Requirements</h1>
            </div>
          @endif
        </form>
      </main>
