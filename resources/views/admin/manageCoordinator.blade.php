    ...
    <section id="content">
      ...
      <main>
        ...
        <ul class="breadcrumbs">
          <li><a href="#">Home</a></li>
          <li class="divider">/</li>
          <li><a href="#" class="active">Manage Coordinator</a></li>
        </ul>
        @if(session('success'))
            ...
            <tr>
              ...
              <td class="action">
                <div class="action_btn">
                  <a href="{{ route('editCoordinator', ['coordinator' => $coordinator])}}" class="btn view"
                    >View <i class="bx bx-show"></i
                  ></a>
                  <form method="post" action="{{ route('deleteCoordinator', ['coordinator' => $coordinator]) }}">
                    @csrf
                    @method('delete')
