              ...
              <tr>
                ...
                <td class="action">
                  <div class="action_btn">
                    <a href="{{ route('admin.viewrequirement', ['requirement' => $requirement])}}" class="btn view"
                      >View <i class="bx bx-show"></i
                    ></a>
                    <form method="post" action="{{ route('admin.deleterequirement', ['requirement' => $requirement]) }}">
                      @csrf
                      @method('delete')
