    ...
    <section id="content">
      ...
      <main>
        ...
        <ul class="breadcrumbs">
          ...
          @endif
        <!-- Form -->
        <form method="post" action="{{ route('coordinator.updaterequirement', ['requirement' => $requirement ]) }}" enctype="multipart/form-data">
          <!-- Requierment Info -->
          @csrf
          @method('put')
            ...
            <div class="form_content">
              <div class="form_group">
                ...
                <div class="form_btn_container view">
                  <a href="{{ route("coordinator.managerequirement") }}" class="btn back_btn">Back</a>
