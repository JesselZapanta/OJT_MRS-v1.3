  ...
  <body>
    ...
    <section id="sidebar">
      ...
      <ul class="side-menu">
        ...
        <li>
          <a href="{{ route('coordinator.managerequirement') }}" class="active"
    ...
    <section id="content">
      ...
      <main>
        ...
        <ul class="breadcrumbs">
          <li><a href="#">Home</a></li>
          <li class="divider">/</li>
          <li><a href="#" class="active">Manage Requirements</a></li>
        </ul>
              ...
              <tr>
                  ...
                  <td class="action">
                      <div class="action_btn">
                          <a href="{{ route('coordinator.viewrequirement', ['requirement' => $requirement]) }}" class="btn view">
                              View <i class="bx bx-show"></i>
                          </a>

                          <form method="post" action="{{ route('coordinator.deleterequirement', ['requirement' => $requirement]) }}">
                              @csrf
                              @method('delete')
                              <button type="submit" class="btn danger">Delete <i class="bx bx-trash"></i></button>
                          </form>
                      </div>
                  </td>
              </tr>
