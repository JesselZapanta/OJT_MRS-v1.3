  ...
  <body>
    ...
    <section id="sidebar">
      ...
      <ul class="side-menu">
        ...
        <li>
          <a href="{{ route('manageintern.view') }}" class="active"
    ...
    <section id="content">
      ...
      <main>
        ...
        <!-- Form -->
          <form method="post" action="{{ route('manageintern.update', ['intern' => $intern ]) }}" enctype="multipart/form-data">
          @csrf
          @method('put')
            ...
            <div class="form_content">
              <div class="form_group">
                ...
                <div class="form_btn_container view">
                  <a href="{{ route('manageintern.view') }}" class="btn back_btn">Back</a>
