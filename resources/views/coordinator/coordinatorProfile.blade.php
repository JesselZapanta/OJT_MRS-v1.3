  ...
  <body>
    ...
    <section id="content">
      ...
      <main>
        ...
        <!-- Form -->
        <form method="post" action="{{ route('coordinatorprofile.update', ['coordinator' => $coordinator ]) }}" enctype="multipart/form-data">
          @csrf
          @method('put')
              ...
              <div class="form_group">
                ...
                <div class="form_input">
                  ...
                  <div class="form_btn_container view">
                    <a href="{{ route('coordinatordashboard') }}" class="btn back_btn">Back</a>
